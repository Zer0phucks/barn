...
city = sys.argv[1] if len(sys.argv) > 1 else "OAKLAND"

report_lines = []
report_lines.append(f"# {city.capitalize()} Delinquent Property Report")
report_lines.append("")
...
input_file = f"/home/noob/barn/scan/delinquent_over_2_years_{city.lower()}.txt" if city != "OAKLAND" else "/home/noob/barn/scan/delinquent_over_2_years.txt"
...
output_file = f"{city.lower()}_property_report.md"
